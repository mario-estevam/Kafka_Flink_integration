...
public class Receptor {
	public static void main(String[] args) throws Exception {
		...
		String inputTopic = "test2"; // nome do topico criado no kafka 
	...
	public static void StramConsumrer(String inputTopic, String server) throws Exception {
		...
		stringInputStream.map(new MapFunction<String, String>() {
			...
			public String map(String value) throws Exception {
				return "Receiving from Kafka : " + value; // mensagem que foi enviada no kafka será printada no console
			}
		}).print();
